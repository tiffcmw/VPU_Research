...
REM
REM Generated by Vivado on Tue Dec 16 04:09:27 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_vpu_core_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_vpu_core_vlog.prj -log xvlog.log
